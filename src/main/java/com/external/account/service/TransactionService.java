...
public class TransactionService {
    ...
    public List<TransactionListResponse> getTransactions(String accessToken, String fintechUseNum) {
        ...
        List<AccountTransaction> transactions = transactionMapper.findTransactionList(fintechUseNum, fromDate, toDate);
